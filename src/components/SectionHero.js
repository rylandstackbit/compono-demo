...
export default function SectionHero(props) {
    ...
    return (
        <section id={sectionId} className={`block hero-block outer`} style={{background: `linear-gradient( to right, ${backgroundColorLeft}, ${backgroundColorRight})`, backgroundImage: `url(${backgroundImage})`, backgroundSize: `cover`, backgroundRepeat: `no-repeat`, backgroundPosition:`center`, overflow: `hidden`}}>
            <div className="inner">
