...
export default function SectionHero(props) {
    ...
    return (
        <section id={sectionId} className={`block hero-block outer`} style={{background: `linear-gradient( to right, ${backgroundColorLeft}, ${backgroundColorRight})`, backgroundImage: `url(${backgroundImage})`, backgroundSize: `auto`, backgroundRepeat: `no-repeat`, backgroundPosition: `center`}}>
            <div className="inner">
